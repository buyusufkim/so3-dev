...
import { toWhatsappUrl, dayTranslations } from "@/features/site-settings/utils";
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-12 md:mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-12 sm:gap-24 md:text-right">
             ...
             {(!loading && (social?.instagram_username || contact?.whatsapp)) && (
               <div className="flex flex-col md:items-end">
                 <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-white/50 mb-3">Sosyal</span>
                 <div className="flex items-center gap-5">
                    {social?.instagram_username && (
                      <a href={`https://www.instagram.com/${social.instagram_username}/`} target="_blank" rel="noopener noreferrer" aria-label="SO3 Instagram">
                    ...
                    {contact?.whatsapp && (
                      <a href={toWhatsappUrl(contact.whatsapp)} target="_blank" rel="noopener noreferrer" aria-label="SO3 WhatsApp">
