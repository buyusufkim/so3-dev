...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Optional tooltip */}
      <span className="absolute right-full mr-4 bg-[#0A0A0A] text-white text-xs font-semibold px-3 py-2 rounded-md opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
        Bize Yazın
      </span>
    </a>
  );
