...
export function TrainersHero() {
  return (
    <section className="relative h-[55svh] md:h-[70svh] min-h-[500px] flex items-center justify-center bg-[#050505] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <HomeMediaPlaceholder label="SO3 EKİP" className="w-full h-full object-cover opacity-60 mix-blend-luminosity" />
      ...
      <div className="container relative z-10 mx-auto px-6 lg:px-12 flex flex-col items-center justify-center text-center mt-12 md:mt-16">
        ...
        <p className="text-sm md:text-base text-white/50 font-medium max-w-xl mx-auto leading-relaxed">
          SO3'te antrenman süreci, çalıştığın eğitmenle birlikte şekillenir.
        </p>
      </div>
    </section>
  );
