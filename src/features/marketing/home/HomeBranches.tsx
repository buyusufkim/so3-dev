...
export function HomeBranches() {
  return (
    <section id="branslar" className="py-24 md:py-32 px-4 sm:px-6 lg:px-12 bg-[#050505] text-white scroll-mt-24 md:scroll-mt-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
          ...
          <div className="lg:col-span-8 group relative rounded-lg overflow-hidden border border-white/10 min-h-[500px] lg:min-h-[600px] flex flex-col justify-end p-8 md:p-12 cursor-pointer">
            <div className="absolute inset-0 z-0">
              <HomeMediaPlaceholder label="FITNESS" aspectRatio="auto" className="w-full h-full transition-transform duration-700 group-hover:scale-105" />
            </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-4 md:gap-6">
            ...
            <div className="flex-1 group relative rounded-lg overflow-hidden border border-white/10 min-h-[300px] flex flex-col justify-end p-6 md:p-8 cursor-pointer">
              <div className="absolute inset-0 z-0">
                <HomeMediaPlaceholder label="YOGA & PİLATES" aspectRatio="auto" className="w-full h-full transition-transform duration-700 group-hover:scale-105" />
              </div>
            ...
            <div className="flex-1 group relative rounded-lg overflow-hidden border border-white/10 min-h-[300px] flex flex-col justify-end p-6 md:p-8 cursor-pointer">
              <div className="absolute inset-0 z-0">
                <HomeMediaPlaceholder label="BOKS" aspectRatio="auto" className="w-full h-full transition-transform duration-700 group-hover:scale-105" />
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-[#050505] via-[#050505]/40 to-transparent z-10 opacity-80"></div>
